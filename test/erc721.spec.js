...
var MyERC721 = artifacts.require("YYToken");
...
contract('Testing ERC721 contract', function(accounts) {
    ...
    it(' should be able to deploy and mint ERC721 token', async () => {
        ...
        await token.mintUniqueTokenTo(account1, tokenId1, tokenUri1, {from: accounts[0], gas:5000000000})
    ...
    it(' should be unique', async () => {
        const duplicateTokenID = token.mintUniqueTokenTo(account2, tokenId1, tokenUri2, {from: accounts[0], gas:5000000000}) //tokenId
    ...
    it(' should allow creation of multiple unique tokens and manage ownership', async () => {
        const additionalToken = await token.mintUniqueTokenTo(account2, tokenId2, tokenUri2, {from: accounts[0], gas:5000000000})
